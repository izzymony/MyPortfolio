    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          <motion.p
            className="text-xs text-[#555] mt-3"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden text-white">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex justify-between items-center h-16">
              ...
              >
                ...
                <button
                  title="Toggle theme"
                  className="w-8 h-8 rounded-full flex items-center justify-center text-[#666] hover:text-white transition-colors"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                ...
                <div className="px-6 py-4 space-y-3">
                  {[
                    ...
                    <button
                      key={item}
                      onClick={() => scrollToSection(item)}
                      className="block w-full text-left text-sm text-[#888] hover:text-white capitalize transition-colors py-1"
                    >
                      {item}
                    </button>
                  ))}
        ...
        >
          <div className="text-center max-w-3xl mx-auto">
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#111] border border-[#1a1a1a] rounded-full text-sm text-[#888] mb-8"
            ...
            {/* Tech Stack Row */}
            <motion.div
              className="flex items-center justify-center gap-6 text-[#555] text-xs"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.6, delay: 1.0 }}
            >
              <span className="text-[#444]">TECH STACK</span>
              <span className="text-[#222]">|</span>
              <div className="flex items-center gap-4">
                {["React", "Next.js", "TypeScript", "Tailwind"].map((tech) => (
                  <span key={tech} className="text-[#555] hover:text-white transition-colors cursor-default">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <motion.a
                    ...
                    className="w-10 h-10 rounded-full bg-[#111] border border-[#1a1a1a] flex items-center justify-center text-[#888] hover:text-white hover:border-[#333] transition-all"
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      <span className="text-xs bg-[#1a1a1a] text-[#888] px-3 py-1 rounded-full border border-[#222]">
                        {exp.period}
                      </span>
                      <motion.svg
                        ...
                        <div className="px-6 pb-6 pt-0">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {exp.skills.map((skill) => (
                              <span
                                key={skill}
                                className="text-xs bg-[#1a1a1a] text-[#888] px-3 py-1 rounded-full border border-[#222]"
                              >
                                {skill}
                              </span>
                            ))}
        ...
        <section id="projects" className="py-24 px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <motion.p
              className="text-[#888] mb-12 max-w-xl"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 0.2 }}
                      ...
                      <div className="w-full md:w-56 lg:w-64 h-56 md:h-56 lg:h-64 rounded-xl overflow-hidden bg-[#1a1a1a] flex-shrink-0 relative">
                        {proj.image_url ? (
                          <Image
                            ...
                            width={256}
                            height={224}
                            sizes="(max-width: 767px) calc(100vw - 48px), (max-width: 1023px) 224px, 256px"
                          ...
                          <div className="w-full h-full flex items-center justify-center text-[#444]">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m7.5-7.5l-5.159 5.159a2.25 2.25 0 01-3.182 0L6.75 9.75m9 6l2.25-2.25m0 0l-2.25-2.25m2.25 2.25L21 21" />
                            </svg>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        {proj.live_url && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-[#888] hover:text-white transition-colors flex items-center gap-1.5"
                          >
                            <svg
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              >
                ...
                {[
                  ...
                  >
                    <div className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-[#888]">
                      {item.icon}
                    </div>
                    <div>
                      <p className="text-xs text-[#666] mb-0.5">{item.label}</p>
                ...
                <div className="flex items-center gap-3 pt-4">
                  {[
                    ...
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-lg bg-[#111] border border-[#1a1a1a] flex items-center justify-center text-[#666] hover:text-white hover:border-[#333] transition-all"
        ...
        {/* =============== FOOTER =============== */}
        <footer className="pt-16 pb-8 px-6 border-t border-[#1a1a1a] relative z-10">
          <div className="max-w-6xl mx-auto">
        ...
        <AnimatePresence>
          {scrollProgress > 20 && (
            <motion.button
              ...
              className="fixed bottom-8 right-8 z-50 bg-white text-black p-3 rounded-full shadow-lg transition-colors hover:bg-white/90"
