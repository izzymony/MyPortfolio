  ...
  return (
    <>
      ...
      <div className='min-h-screen bg-white relative overflow-hidden'>
         ...
         <nav className="fixed top-0 w-full z-40 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
              ...
              >
                {['home', 'about', 'services', 'skills', 'projects', 'contact'].map((item, index) => (
                  <motion.button
                    ...
                    className={`capitalize transition-colors duration-300 hover:text-[#2F73F2] relative font-medium ${
                      activeSection === item ? 'text-[#2F73F2]' : 'text-gray-700'
                    }`}
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                {['home', 'about', 'services', 'skills', 'projects', 'contact'].map((item, index) => (
                  <motion.button
                    key={item}
                    onClick={() => scrollToSection(item)}
                    className="block w-full text-left px-3 py-2 text-gray-700 hover:text-[#2F73F2] capitalize font-medium"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
          ...
          <section id='home' className='min-h-screen flex items-center justify-center px-4 relative z-10'>
           ...
           <section id="about" className="py-20 px-4 bg-[#F0F8FF] relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                className="bg-white rounded-lg p-8 border border-[#2F73F2]/20 shadow-lg"
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.6 }}
              ...
              {[
                {
                  ...
                  description: "Creating mobile-first, responsive websites that work flawlessly across all devices and screen sizes."
                },
                {
                  icon: (
                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  description: "Building modern web applications using React, Next.js, and TypeScript with best practices."
                },
                {
                  icon: (
                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  description: "Implementing secure and scalable database solutions with Firebase and Supabase."
                },
                {
                  icon: (
                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  description: "Optimizing web applications for speed, efficiency, and excellent Core Web Vitals scores."
                },
                {
                  icon: (
                    <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <motion.div
                  key={index}
                  className="bg-white rounded-lg p-8 border border-gray-200 hover:border-[#2F73F2] transition-all duration-300 shadow-md"
                  variants={fadeInUp}
                  whileHover={{
                    y: -10,
        ...
        {/* Statistics Section */}
        <section className="py-20 px-4 bg-[#F0F8FF] relative z-10">
          <div className="max-w-6xl mx-auto">
            <motion.div
             ...
             >
               {skills.map((skill, index) => {
                 ...
                 return (
                   <motion.div
                     key={index}
                     className='bg-white rounded-lg p-6 border border-gray-200 hover:border-[#2F73F2] transition-all duration-300 flex flex-col items-center justify-center text-center'
                     variants={fadeInUp}
                     whileHover={{
                       scale: 1.05,
                   ...
                   >
                     ...
                     <span className='text-gray-900 font-semibold text-sm mb-2'>{skill.name}</span>
        ...
        <section id="projects" className="py-20 px-4 bg-[#F0F8FF] relative z-10">
          <div className="max-w-6xl mx-auto">
            <motion.h2
              className="text-4xl font-bold text-gray-900 mb-12 text-center"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              {project.map((proj, index) => (
                <motion.div
                  key={proj.id}
                  className="bg-white h-full rounded-lg overflow-hidden border border-gray-200 hover:border-[#2F73F2] transition-all duration-300 shadow-md"
                  variants={scaleIn}
                  whileHover={{
                    y: -10,
                    boxShadow: "0 20px 40px rgba(47, 115, 242, 0.2)"
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {proj.tech_stack?.map((tech, techIndex) => (
                        <motion.span
                          key={techIndex}
                          className="bg-[#2F73F2]/10 text-[#2F73F2] px-3 py-1 rounded-full text-sm font-medium"
                          initial={{ opacity: 0, scale: 0 }}
                          whileInView={{ opacity: 1, scale: 1 }}
                          viewport={{ once: true }}
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="text-gray-700">ojehonmonisrael008@gmail.com</span>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="text-gray-700">+234 906 579 8272</span>
                  </motion.div>
              ...
              >
                ...
                >
                  <input
                    ...
                    className="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-[#2F73F2] focus:ring-2 focus:ring-[#2F73F2]/20 transition-all"
                  />
                  <ValidationError
                    prefix='Name'
                    field='name'
                ...
                >
                  <textarea
                    ...
                    required
                    className="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-[#2F73F2] focus:ring-2 focus:ring-[#2F73F2]/20 transition-all resize-none"
                  />
                  <ValidationError
                    prefix="Message"
                    field="message"
        ...
        {/* Footer */}
        <footer className="py-8 px-4 border-t border-gray-200 bg-[#F0F8FF] relative z-10">
