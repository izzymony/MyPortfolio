...
export default function Home() {
  ...
  const projects: Project[] = [
    {
      ...
      description: "A car rental platform built with Next.js and Firebase, featuring real-time booking and user authentication.",
      technologies: ["Next.js", "Javascript", "Firebase"],
      image: "/carrentify.png",
      github: "https://github.com/izzymony/carRentify/tree/cars",
      demo: "https://car-rentify-six.vercel.app/"
    },
    {
      id: 2,
      title: "E-Commerce Platform",
  ...
  <div
    key={project.id}
    className="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden border border-white/20 hover:border-purple-400/50 transition-all duration-300 transform hover:scale-105"
  >
